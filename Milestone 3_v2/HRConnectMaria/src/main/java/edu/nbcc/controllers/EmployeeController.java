...
public class EmployeeController extends jakarta.servlet.http.HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (path==null) {
			...
			if (request.getParameter("hireDate") !=null && request.getParameter("hireDate") !="" ) {
				hireDate = (String)request.getParameter("hireDate");
			}
			
			if (request.getParameter("terminatedDate") !=null && request.getParameter("terminatedDate") !="") {
				terminatedDate = (String)request.getParameter("terminatedDate");
			}
			...
			if (request.getParameter("isActive") !=null && request.getParameter("isActive") !="") {
				isActive = (String)request.getParameter("isActive");
			}
			
			List<Employee> list = dao.findAll(filter, firstName, lastName, hireDate, terminatedDate, gender, isActive);
